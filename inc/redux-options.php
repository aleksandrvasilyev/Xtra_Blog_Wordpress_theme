...
$opt_name = 'xtrablogs_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sample Options', 'xtrablog' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'xtrablog' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Site settings', 'xtrablog' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'xtrablog' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header settings', 'xtrablog' ),
		...
		'fields'           => array(
			array(
				'id'       => 'xtrablog-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Text Field', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'Field Description', 'xtrablog' ),
				'default'  => '',
			),
			array(
				'id'       => 'xtrablog-editor-header',
				'type'     => 'editor',
				'title'    => esc_html__( 'Header description', 'xtrablog' ),
				'subtitle' => esc_html__( 'Insert header description', 'xtrablog' ),
				'desc'     => esc_html__( 'This is the description field, again good for additional info.', 'xtrablog' ),
				'default'  => '',
			),
			array(
				'id'           => 'xtrablog-logo',
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Media w/ URL', 'xtrablog' ),
				'compiler'     => 'true',
			...
			array(
				'id'       => 'xtrablog-facebook-link',
				'type'     => 'text',
				'title'    => esc_html__( 'Facebook link', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'Field Description', 'xtrablog' ),
				'default'  => '',
			),
			array(
				'id'       => 'xtrablog-twitter-link',
				'type'     => 'text',
				'title'    => esc_html__( 'Twitter link', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'Field Description', 'xtrablog' ),
				'default'  => '',
			),
			array(
				'id'       => 'xtrablog-instagram-link',
				'type'     => 'text',
				'title'    => esc_html__( 'Instagram link', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'Field Description', 'xtrablog' ),
				'default'  => '',
			),
			array(
				'id'       => 'xtrablog-linkedin-link',
				'type'     => 'text',
				'title'    => esc_html__( 'Linkedin link', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'Field Description', 'xtrablog' ),
				'default'  => '',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer settings', 'xtrablog' ),
		'id'               => 'site_settings_footer',
		'subsection'       => true,
		'customizer_width' => '500px',
		'fields'           => array(
			array(
				'id'       => 'xtrablog-editor-footer',
				'type'     => 'editor',
				'title'    => esc_html__( 'Textarea Option - HTML Validated Custom', 'xtrablog' ),
				'subtitle' => esc_html__( 'Subtitle', 'xtrablog' ),
				'desc'     => esc_html__( 'This is the description field, again good for additional info.', 'xtrablog' ),
