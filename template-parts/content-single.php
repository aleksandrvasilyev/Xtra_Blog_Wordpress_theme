...
как пост будет выглядеть в одиночном посте
        ...
        <div class="col-lg-8 tm-post-col">
            <div class="tm-post-full">
                <div class="mb-4">
                    ...
                    <p class="tm-mb-40"><?php xtrablog_posted_on();?> <?php echo esc_html__('posted');?> <?php echo esc_html__(xtrablog_posted_by());?></p>
                    <?php the_content(); ?>
                ...
                <!-- Comments -->
                <div>
                    <h2 class="tm-color-primary tm-post-title"><?php echo esc_html__('Comments'); ?></h2>
